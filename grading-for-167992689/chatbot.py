    ...
    def process(self, line):
        ...
        if self.creative:
            ...
            if self.count == 5 and self.first_run == True: 
                ...
                movie_rec = movies_dict[self.get_first_recommend()]
                response = self.okay[random.randint(0, len(self.okay) - 1)] + given[random.randint(0, len(given) - 1)] + "I think you would like {}.".format(movie_rec) + self.emojis[random.randint(0, len(self.emojis) - 1)] + ' ' + 'Would you like more recommendations?'
            ...
            if self.count < 3 and self.first_run == True and self.more_than_one == True: 
                ...
                return "Yay glad you like {}. Hit me up with more movies you like!".format(movies_dict[result[0]])
